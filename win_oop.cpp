...
public:
    ...
    void isValid();
    void print();
    void checkDataKey(const int, const char*);
    int checkData(const string&);

    template<typename Type, SortType sort_type>
    friend void insertionSort(Type*, const int&);

    template<typename Type>
    friend void printArray(vector<Type>, const string&);
};
